...
import com.loyalteams.http.BuildConfig;
...
public class NetworkSpace {
    ...
    private static void assertTrue(boolean f) {
        if (!f)
    ...
    public static class ipAddress implements Comparable<ipAddress> {
        ...
        ipAddress(Inet6Address address, int mask, boolean include) {
            networkMask = mask;
            included = include;
    ...
    private final TreeSet<ipAddress> mIpAddresses = new TreeSet<ipAddress>();
